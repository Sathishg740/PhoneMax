...
namespace PhoneMax_1._1.Controllers
{
    public class AdminController : Controller
    {
        ...
        public IActionResult Create(ProductDetails product)
        {
            ...
            {
                string sql = $"Insert Into ProductDetails (Product_Name,Category_Name,Brand_Name,Price,Description,Image) Values ( '{product.Product_Name}','{product.Category_Name}', '{product.Brand_Name}', '{product.Price}','{product.Description}','{product.Image}' )";
